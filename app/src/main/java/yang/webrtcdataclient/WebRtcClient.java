...
public class WebRtcClient {
    ...
    private final static String mSocketAddress = "http://35.154.30.2:3000/";
//    private final static String mSocketAddress = "http://192.168.8.51:3000/";
...
//        iceServers.add(new PeerConnection.IceServer("turn:192.158.29.39:3478?transport=tcp", "JZEOEt2V3Qb0y27GRntt2u2PAYA=", "28224511:1379330808"));
    ...
    public void onReceiveUserList(JSONObject data) throws JSONException {
        Log.d(TAG, "onReceiveUserList uid:" + " data:" + data);
        ...
        if (webRtcListener != null) {
            webRtcListener.onReceiveOtherMessage(0, users);
        }
    }
    ...
    public interface WebRtcListener {
        ...
        void onReceiveOtherMessage(int type, Object parameter);
    }
}
